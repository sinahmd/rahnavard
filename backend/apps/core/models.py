...
class SiteSettings(models.Model):
    ...
    # Hero Section
    hero_cta_primary_text = models.CharField(max_length=100, default='مشاهده خودروها', verbose_name='متن دکمه اصلی هیرو')
    hero_cta_primary_link = models.CharField(max_length=200, default='#cars', verbose_name='لینک دکمه اصلی')
    hero_cta_secondary_text = models.CharField(max_length=100, default='درخواست مشاوره', verbose_name='متن دکمه فرعی هیرو')
    hero_cta_secondary_link = models.CharField(max_length=200, default='#consult', verbose_name='لینک دکمه فرعی')

    # Why Section
    why_title = models.CharField(max_length=200, default='چرا راهنورد خودرو؟', verbose_name='عنوان بخش چرا ما')
    ...
    # Cars Section
    cars_section_title = models.CharField(max_length=200, default='خودروهای ما', verbose_name='عنوان بخش خودروها')
    ...
    # Articles Section
    articles_section_title = models.CharField(max_length=200, default='مقاله و اطلاعیه', verbose_name='عنوان بخش مقالات')
    ...
    # Branches Section
    branches_section_title = models.CharField(max_length=200, default='شعب راهنورد خودرو', verbose_name='عنوان بخش شعب')

    # Consultation Form
    form_title = models.CharField(max_length=200, default='درخواست خود را برای ما ارسال نمایید', verbose_name='عنوان فرم مشاوره')
    ...
    footer_copyright = models.CharField(max_length=200, default='راهنورد خودرو. تمامی حقوق محفوظ است.', verbose_name='متن کپی‌رایت')
