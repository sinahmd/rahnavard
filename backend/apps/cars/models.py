...
class Car(models.Model):
    ...
    fuel_type = models.CharField(max_length=50, choices=FUEL_TYPE_CHOICES, verbose_name='نوع سوخت')
    transmission = models.CharField(max_length=50, choices=TRANSMISSION_CHOICES, verbose_name='گیربکس')
    engine = models.CharField(max_length=100, blank=True, verbose_name='موتور')
    price = models.DecimalField(max_digits=15, decimal_places=0, null=True, blank=True, verbose_name='قیمت')
    ...
    og_image = models.ImageField(upload_to='og/cars/', blank=True, verbose_name='تصویر OG')
