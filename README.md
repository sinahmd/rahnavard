...
Remaining phases: **Phase 6** (CSP/hardening, compose consolidation, ADRs, secret-scan CI) and the deferred font self-hosting pass. Phase 2's token cutover remains gated on the staging smoke checklist and owner approval.
