...
Remaining phases: **Phase 5** (UI/a11y polish — ConfirmDialog, skip link, reduced motion) and **Phase 6** (CSP/hardening, compose consolidation, ADRs). Phase 2's token cutover remains gated on the staging smoke checklist and owner approval.
